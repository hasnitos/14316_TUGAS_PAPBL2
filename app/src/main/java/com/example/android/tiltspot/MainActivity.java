...
public class MainActivity extends AppCompatActivity
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        File gpxfile = new File(file, "sensor_log.txt");
        try
        {
            BufferedWriter buf = new BufferedWriter(new FileWriter(gpxfile));
            buf.append("Azimuth: " + Float.toString(azimuth) + "; " + "Pitch: " + Float.toString(pitch) + "; " + "Roll: " + Float.toString(roll) + "; \n");
            buf.close();
        }
        catch (IOException e)
        {
